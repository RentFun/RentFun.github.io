...
const TPublicBlock: React.FC<HomePropsType> = () => {
    return(
        <div className="t-block-tooter">
            ...
            <img onClick={openUrl.bind(this, "https://discord.gg/rentfun")} className="t-block-icon" src={require("./images/t1/t1-discord.png")} alt=""/>
            <span onClick={openUrl.bind(this, "https://discord.gg/rentfun")} className="t-block-text">Discord</span>
    ...
    return(
        <div className="t-block t-public-padding center">
            <div className="t-f-icon">
                <img onClick={openUrl.bind(this, "https://discord.gg/rentfun")} src={require("./images/foot/f1.png")} alt=""/>
